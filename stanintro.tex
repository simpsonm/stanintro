...
Fake data generated in \verb0stanintro.R0:
{\tiny
\begin{verbatim}
n <- 100
alpha <- 150
...
\begin{align*}
\alpha &\sim \mathrm{Cauchy}(100, 1000^2),\\
\beta_k&\stackrel{iid}{\sim} \mathrm{N}(10, 100^2),\\
\sigma&\sim \mathrm{half-T}_{d_{\sigma}}(0, 100^2).
\end{align*}
\end{frame}
...
\begin{center}
\includegraphics[width = 0.99\textwidth]{new/traceplot1.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width = 0.99\textwidth]{new/traceplot2.png}
\end{center}
\end{frame}
...
\item Geometric ergodicity typically fails \textbf{\emph{using any method}}.\\~\\
\end{itemize}
How to fix this?
\begin{itemize}
...
\begin{frame}[fragile]
\frametitle{Centered vs. noncenteredparameterizations}
\begin{align*}
...
\end{center}
Good results from setting $\bm{M}$ to a function of the Hessian of {\color{red}$\pi(\bm{q})$}.\\
