...
\end{center}
From \textbf{HMC for Hierarchical Models}:\url{https://arxiv.org/pdf/1312.0906.pdf}
\end{frame}
...
From the manual:
\begin{center}
\includegraphics[width=0.6\textwidth]{stanfuture.png}
\end{center}
Implementation problem: now need the Hessian of the target density. They're working on it.
\end{frame}
